...
use App\AlgoExpert\MinimumWaitingTime;
use PHPUnit\Framework\TestCase;

class MinimumWaitingTimeTest extends TestCase
{
     ...
     * @test
     */
    public function minimum_waiting_time_test($arr, $result)
    {
        $this->assertSame($result, MinimumWaitingTime::find($arr));
    }
